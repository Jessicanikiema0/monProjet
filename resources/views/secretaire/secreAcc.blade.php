...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <h1 style="text-align: center; color: white" >Secretariat</h1></span></br>
...
<div class="content-wrapper">
    ...
    <img src="/access/img/secre.JPEG" width="1500px" height="720px" alt="Cover Image"/>
              ...
              <li class="nav-item">
                   ...
                   <li class="nav-item">
                    <a href="" class="nav-link">
                      ...
                      <p style="margin-left: 00px;"> Gestion de RDV</p>
                    </a>
                 </li>
                 ...
                 <li class="nav-item">
                    <a href="" class="nav-link">
                      <i class="fas fa-folder"></i>
                      <p style="margin-left: 00px;"> Prise RDV</p>
                    </a>
                 </li>
                 <li class="nav-item">
                    <a href="" class="nav-link">
