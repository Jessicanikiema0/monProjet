...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <span style="margin-left:340px; margin-top: 0px;" class="brand-text font-weight-light;"><h1 style="text-align: center; color: black" >BIENVENUE A MEDICAL CENTER </h1></span>
        <img class="animation__wobble" src="{{ asset('access') }}/img/logo.JPEG" alt="AdminLTELogo" height="90" width="150">
      ...
      <h1 style="text-align: center; color: white" >MEDECIN</h1></span></br>
...
<div class="content-wrapper">
    ...
    <img src="/access/img/medec.JPEG" width="1500px" height="720px" alt="Cover Image"/>
              ...
              <li class="nav-item">
                   ...
                   <li class="nav-item">
                    <a href="" class="nav-link">
                      ...
                      <p style="margin-left: 00px;"> Gestion Calendrier</p>
                    </a>
                 </li>
                 ...
                 <li class="nav-item">
                    <a href="" class="nav-link">
                      <i class="fas fa-folder"></i>
                      <p style="margin-left: 00px;"> Gestion Patient</p>
                    </a>
                 </li>
                 ...
                 <li class="nav-item">
                    <a href="" class="nav-link">
                      <i class="fas fa-folder"></i>
                      <p style="margin-left: 00px;"> Fiche Patient</p>
                    </a>
                 </li>
                 ...
                 <li class="nav-item">
                    <a href="" class="nav-link">
                      <i class="fas fa-folder"></i>
                      <p style="margin-left: 00px;"> Dossier Medical</p>
                    </a>
                 </li>
                 <li class="nav-item">
                    <a href="" class="nav-link">
                      <i class="fas fa-folder"></i>
                      <p style="margin-left: 00px;"> Patologie</p>
                    </a>
                 </li>
                 </body>
